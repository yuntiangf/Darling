...
public class ModelDetailItemsAdapter extends ArrayAdapter<Integer> {
    ...
    public ModelDetailItemsAdapter(Context context, int layoutResourceId, Integer[] items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
            ...
            ImageView itemImage = (ImageView)row.findViewById(R.id.detail_item_image);
	...
	private void setImageBitmap(Integer item, ImageView imageView){
		...
		float i = (imageWidth) / (bitmap.getWidth());
