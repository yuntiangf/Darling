...
public class ShakeResult5 extends BaseFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shake_result_five);

		imageUtil = new ImageUtil(ShakeResult5.this);
		// 初始化图片
		initialImages();
	...
	private void initialImages() {
		...
		LoadImageInfo imgModel = new LoadImageInfo(shake_model,
				(ImageView) findViewById(R.id.shake_model));
		LoadImageInfo img1 = new LoadImageInfo(shake_item1,
				(ImageView) findViewById(R.id.shake_item1));
		LoadImageInfo img2 = new LoadImageInfo(shake_item2,
				(ImageView) findViewById(R.id.shake_item2));
		LoadImageInfo img3 = new LoadImageInfo(shake_item3,
				(ImageView) findViewById(R.id.shake_item3));
		LoadImageInfo img4 = new LoadImageInfo(shake_item4,
				(ImageView) findViewById(R.id.shake_item4));
		LoadImageInfo img5 = new LoadImageInfo(shake_item5,
				(ImageView) findViewById(R.id.shake_item5));
	...
	private void loadImages(List<LoadImageInfo> lstImageInfos) {
		...
		try {
			...
			for (int i = 0; i < lstImageInfos.size(); i++) {
				...
				imageUtil.loadImage(imgName, imgPath, true,
						new ImageCallback() {
